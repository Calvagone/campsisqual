...
A library dedicate to the qualification of the Campsis Suite and to the qualification of Campsis models, provided you have the `campsistrans` package.
...
```{r, message=FALSE, eval=EVAL_CODE}
library(campsis)
...
Create a dataset using Campsis. For instance, inject a bolus of 1000 mg into the absorption compartment.
...
Disable inter-individual variability (IIV) and residual unexplained variability (RUV). 
