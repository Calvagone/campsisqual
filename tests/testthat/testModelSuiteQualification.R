...
get_all_model_names <- function() {
  pks <- c(
    ...
    "1cpt_fo_lag_mm",
    "1cpt_fo_transit_mm",
    "1cpt_weibull_original_mm",
    "1cpt_weibull_mm",
    "1cpt_weibull_double_mm",
    "1cpt_mmabs_mm",
    "1cpt_zo_mm",
    "1cpt_fo_mixed",
    "1cpt_fo_lag_mixed",
    "1cpt_fo_transit_mixed",
    "1cpt_weibull_original_mixed",
    "1cpt_weibull_mixed",
    "1cpt_weibull_double_mixed",
    "1cpt_mmabs_mixed",
    "1cpt_zo_mixed",
    "2cpt_fo",
    "2cpt_fo_lag",
    "2cpt_fo_transit",
    "2cpt_weibull_original",
    "2cpt_weibull",
    "2cpt_weibull_double",
    "2cpt_mmabs",
    "2cpt_zo",
    ...
    "2cpt_fo_lag_mm",
    "2cpt_fo_transit_mm",
    "2cpt_weibull_original_mm",
    "2cpt_weibull_mm",
    "2cpt_weibull_double_mm",
    "2cpt_mmabs_mm",
    "2cpt_zo_mm",
    "2cpt_fo_mixed",
    "2cpt_fo_lag_mixed",
    "2cpt_fo_transit_mixed",
    "2cpt_weibull_original_mixed",
    "2cpt_weibull_mixed",
    "2cpt_weibull_double_mixed",
    "2cpt_mmabs_mixed",
    "2cpt_zo_mixed",
    "3cpt_fo",
    "3cpt_fo_lag",
    "3cpt_fo_transit",
    "3cpt_weibull_original",
    "3cpt_weibull",
    "3cpt_weibull_double",
    "3cpt_mmabs",
    "3cpt_fo_mm",
    "3cpt_fo_lag_mm",
    "3cpt_fo_transit_mm",
    "3cpt_weibull_original_mm",
    "3cpt_weibull_mm",
    "3cpt_weibull_double_mm",
    "3cpt_mmabs_mm",
    "3cpt_fo_mixed",
    "3cpt_fo_lag_mixed",
    "3cpt_fo_transit_mixed",
    "3cpt_weibull_original_mixed",
    "3cpt_weibull_mixed",
    "3cpt_weibull_double_mixed",
    "3cpt_mmabs_mixed",
    "1cpt_fo_tmdd_full",
    "1cpt_zo_tmdd_full",
    "2cpt_fo_tmdd_full",
    "2cpt_zo_tmdd_full",
    "1cpt_fo_tmdd_full_cst_rtot",
    "1cpt_zo_tmdd_full_cst_rtot",
    "2cpt_fo_tmdd_full_cst_rtot",
    "2cpt_zo_tmdd_full_cst_rtot",
    "1cpt_fo_tmdd_full_ib",
    "1cpt_zo_tmdd_full_ib",
    "2cpt_fo_tmdd_full_ib",
    "2cpt_zo_tmdd_full_ib",
    "1cpt_fo_tmdd_full_cst_rtot_ib",
    "1cpt_zo_tmdd_full_cst_rtot_ib",
    "2cpt_fo_tmdd_full_cst_rtot_ib",
    "2cpt_zo_tmdd_full_cst_rtot_ib",
    "1cpt_fo_tmdd_qe",
    "1cpt_zo_tmdd_qe",
    "2cpt_fo_tmdd_qe",
    "2cpt_zo_tmdd_qe",
